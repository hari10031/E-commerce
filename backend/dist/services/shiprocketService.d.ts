...
export declare function getCourierStrategy(): CourierStrategy;
export declare function selectBestCourier(couriers: CourierOption[], strategy?: CourierStrategy): CourierOption | null;
