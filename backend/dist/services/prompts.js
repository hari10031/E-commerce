...
exports.JEWELLERY_PROMPT_COMPACT = exports.SAREE_PROMPT_COMPACT = exports.JEWELLERY_PROMPT_FULL = exports.SAREE_PROMPT_FULL = void 0;
exports.useFullPrompts = useFullPrompts;
exports.sareePrompt = sareePrompt;
exports.jewelleryPrompt = jewelleryPrompt;
exports.SAREE_PROMPT_FULL = `## ROLE
...
`;
exports.JEWELLERY_PROMPT_FULL = `## ROLE
...
`;
exports.SAREE_PROMPT_COMPACT = `Saree visual pipeline. Input: saree photo. Output: ONE real full-body photo of an Indian woman wearing that exact saree in portrait 3:4 aspect ratio (Myntra-style vertical frame). Image only — no text.
...
exports.JEWELLERY_PROMPT_COMPACT = `Jewellery visual pipeline. Input: jewellery photo. Output: ONE real photo of an Indian woman wearing that exact piece on the correct body part (neck/ear/wrist/etc) in portrait 3:4 aspect ratio (Myntra-style vertical frame). Image only — no text.
...
function useFullPrompts() {
    return process.env.GEMINI_FULL_PROMPTS === '1' || process.env.GEMINI_FULL_PROMPTS === 'true';
}
function sareePrompt() {
    return useFullPrompts() ? exports.SAREE_PROMPT_FULL : exports.SAREE_PROMPT_COMPACT;
}
function jewelleryPrompt() {
    return useFullPrompts() ? exports.JEWELLERY_PROMPT_FULL : exports.JEWELLERY_PROMPT_COMPACT;
}
