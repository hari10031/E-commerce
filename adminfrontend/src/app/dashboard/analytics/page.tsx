...
const CategorySalesChart = dynamic(
  () => import('@/components/dashboard/CategorySalesChart').then((m) => m.CategorySalesChart),
  { ssr: false, loading: () => <Skeleton className="h-72 rounded-xl" /> }
);
const OrderStatusPie = dynamic(
  () => import('@/components/dashboard/OrderStatusPie').then((m) => m.OrderStatusPie),
  { ssr: false, loading: () => <Skeleton className="h-72 rounded-xl" /> }
);
